 ...
 *
 */
public class ConjugateBFGSOptimizer implements QuasiNewtonOptimizer {
	...
	public ConjugateBFGSOptimizer(MultiVariableFunction function, VectorFunction gradientFunction, Vector initGuess, long precision) {
